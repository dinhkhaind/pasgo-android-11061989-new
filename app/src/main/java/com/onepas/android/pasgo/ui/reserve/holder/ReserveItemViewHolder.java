...
public class ReserveItemViewHolder extends RecyclerView.ViewHolder {
    ...
    private ReserveItemViewHolder(final View parent, LinearLayout convertView) {
        super(parent);
    ...
    public static ReserveItemViewHolder newInstance(View parent) {
        LinearLayout reserved_parent_ln = (LinearLayout) parent.findViewById(R.id.reserved_parent_ln);
        return new ReserveItemViewHolder(parent, reserved_parent_ln);
    }
    ...
    public void setItemValue(DiemDenModel item, Context context) {
        ...
        uu_dai_wv.setVisibility(View.GONE);
        ...
        item.setCoThePASGO(false);
        if(item.isCoThePASGO())
            btnThePasgo.setVisibility(View.VISIBLE);
        else
