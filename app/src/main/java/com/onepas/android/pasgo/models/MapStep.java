...
public class MapStep {
	...
	private List<MapStepChild> mapStepInfoChilds;
	...
	public List<MapStepChild> getMapStepInfoChilds() {
		return mapStepInfoChilds;
	}

	public void setMapStepInfoChilds(List<MapStepChild> mapStepInfoChilds) {
		this.mapStepInfoChilds = mapStepInfoChilds;
	}
