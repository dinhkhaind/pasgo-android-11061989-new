...
public class MenuActivity extends BaseAppCompatActivity {
    ...
    private ArrayList<AnhBangGia> mAnhBangGias;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mToolbarTitle.setText(getString(R.string.menus));
    }
    @Override
        ...
        Pasgo.getInstance().addToRequestQueue(url, jsonParams,
                new Pasgo.PWListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        mAnhBangGias = ParserUtils.getAnhBangGias(jsonArray);
                        MenuAdapter mAdapter;
                        mAdapter = new MenuAdapter(mActivity, mAnhBangGias, position -> {
                        ...
                        mRcImage.setLayoutManager(new StaggeredGridLayoutManager(5, StaggeredGridLayoutManager.VERTICAL));
