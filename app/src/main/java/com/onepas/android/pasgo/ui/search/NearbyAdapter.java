...
public class NearbyAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.mHereNowTxt = (TextView) convertView
					.findViewById(R.id.tv_here_now);
			holder.mDistanceTxt = (TextView) convertView
					.findViewById(R.id.tv_distance);
			holder.mRibbonImg = (ImageView) convertView
		...
		holder.mRibbonImg
				.setVisibility((venue.type.equals("trending")) ? View.VISIBLE
						: View.INVISIBLE);
