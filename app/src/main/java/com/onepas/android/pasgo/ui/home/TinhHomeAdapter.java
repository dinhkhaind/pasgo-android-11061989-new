...
public class TinhHomeAdapter extends ArrayAdapter<TinhHome> {
	...
	public TinhHomeAdapter(Context context, ArrayList<TinhHome> items, TinhHomeListenner tinhListenner) {
