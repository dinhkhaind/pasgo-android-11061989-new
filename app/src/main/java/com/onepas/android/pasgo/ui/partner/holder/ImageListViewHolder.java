...
public class ImageListViewHolder extends RecyclerView.ViewHolder {
    ...
    public ImageListViewHolder(final View parent, LinearLayout convertView) {
        super(parent);
        imgLogo = (SimpleDraweeView) convertView.findViewById(R.id.imgLogo);
    }

    public static ImageListViewHolder newInstance(View parent) {
        LinearLayout reserved_parent_ln = (LinearLayout) parent.findViewById(R.id.row_detail_image_ln);
        return new ImageListViewHolder(parent, reserved_parent_ln);
    }
