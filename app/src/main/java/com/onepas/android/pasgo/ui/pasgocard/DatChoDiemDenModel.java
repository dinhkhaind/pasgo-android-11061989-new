...
public class DatChoDiemDenModel {
	...
	public String getDieuKienMobile() {
		return dieuKienMobile;
	}

	public void setDieuKienMobile(String dieuKienMobile) {
		this.dieuKienMobile = dieuKienMobile;
	}
