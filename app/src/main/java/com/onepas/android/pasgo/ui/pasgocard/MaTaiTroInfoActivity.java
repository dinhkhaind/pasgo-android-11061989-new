...
public class MaTaiTroInfoActivity extends BaseAppCompatActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        toolbarTitle.setText(R.string.menu_tai_tro);
    ...
    protected void initControl() {
        ...
        {
            checkIn=Constants.KEY_MA_TAI_TRO_INTRODUCTION_VN;
            Utils.Log(TAG, "viet nam");
        }else
        {
            checkIn=Constants.KEY_MA_TAI_TRO_INTRODUCTION_EN;
