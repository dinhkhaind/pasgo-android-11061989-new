...
public class MessageHolders {
    ...
    * */
    ...
    public static class IncomingTextMessageViewHolder<MESSAGE extends IMessage>
        ...
        protected RelativeLayout RlContent, RlLoadMore;
        public IncomingTextMessageViewHolder(View itemView) {
            super(itemView);
            bubble = (ViewGroup) itemView.findViewById(R.id.bubble);
            text = (TextView) itemView.findViewById(R.id.messageText);
            RlContent = (RelativeLayout)itemView.findViewById(R.id.content_rl);
            RlLoadMore = (RelativeLayout)itemView.findViewById(R.id.read_more_rl);
        ...
        public void onBind(MESSAGE message) {
            ...
            if(message.getXemThemLichSu()==0){
                RlContent.setVisibility(View.VISIBLE);
                RlLoadMore.setVisibility(View.GONE);
            }else if(message.getXemThemLichSu()==1){
    ...
    public abstract static class BaseIncomingMessageViewHolder<MESSAGE extends IMessage>
        ...
        public BaseIncomingMessageViewHolder(View itemView) {
            ...
            userAvatar = (SimpleDraweeView) itemView.findViewById(R.id.messageUserAvatar);
        ...
        public void onBind(MESSAGE message) {
            ...
            if(messageName !=null){
                ...
                String displayColor = message.getDisplayColor();
                if (!TextUtils.isEmpty(displayColor)) {
                    messageName.setTextColor(Color.parseColor("#"+displayColor));
                }
            }
            if (userAvatar != null) {
                ...
                if (isAvatarExists) {
                    userAvatar.setBackgroundResource(R.drawable.ic_launcher_full);
                }
            }
        }
